...
* [grabc2clipboard](https://github.com/d630/bin/blob/master/grabc2clipboard): X-select color code.
...
* [mail-get](https://github.com/d630/bin/blob/master/mail-get): Get mail and give notification + sound (via run-logger).
...
* [mail-send](https://github.com/d630/bin/blob/master/mail-send): Send mail via msmtp-queue and give notification + sound (via run-logger).
...
* [pwgen2clipboard](https://github.com/d630/bin/blob/master/pwgen2clipboard): X-select password.
...
* [reconfigure-network-device](https://github.com/d630/bin/blob/master/reconfigure-network-device): Configure my network devices.
...
* [run-pwgen](https://github.com/d630/bin/blob/master/run-pwgen): Create password.
* [run-rtcwake](https://github.com/d630/bin/blob/master/run-rtcwake): Run rtcwake with mode mem and play music/radio on wakeup.
* [run-scrot](https://github.com/d630/bin/blob/master/run-scrot): Take a screenshot.
* [run-source-highlight](https://github.com/d630/bin/blob/master/run-source-highlight): Wrapper: Default highlighting tool.
...
* [run-z](https://github.com/d630/bin/blob/master/run-z): Run z output within file manager.
...
* [sdmenu](https://github.com/d630/bin/blob/master/sdmenu): Run menu as dmenu2-save.
...
* [ssudo](https://github.com/d630/bin/blob/master/ssudo): Use sudo with dmenu2 via SUDO_ASKPASS.
